<h2><a href="https://leetcode.com/problems/flood-fill/">Day 08 (Flood Fill)</a></h2><h3>Easy</h3><hr><div><p>An image is represented by an <code>m x n</code> integer grid <code>image</code> where <code>image[i][j]</code> represents the pixel value of the image.</p>
